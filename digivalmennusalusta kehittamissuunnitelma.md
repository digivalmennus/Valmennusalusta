...
![Integroitu valmennus- ja digiohjausmalli: polku kohti työtä ja opintoja](kuvat/integroitu_digiohjausmalli.png)
...
![Digivalmennusalustan asiakaspolku: ihminen keskiössä, teknologia tukena — uimaradat asiakas, valmentaja ja digialusta](kuvat/asiakaspolku_uimaradat.jpeg)
...
```mermaid
flowchart LR
    subgraph ASIAKAS["Asiakas"]
        direction TB
        A0["Ohjautuu prosessiin<br/>(vaihe 0)"]
        A1["Aloitustapaaminen<br/>(vaihe 1)"]
        A2["Saa tunnukset,<br/>näkee valitun suunnan<br/>(vaihe 2)"]
        A3["Etenee itsenäisesti,<br/>oma tahti/järjestys<br/>(vaihe 3)"]
        A4["Välitapaaminen<br/>(vaihe 4, toistuu)"]
        A5["Aloittaa työn/opinnot<br/>(vaihe 5)"]
        A6["Loppuarviointi<br/>(vaihe 6)"]
        A0 --> A1 --> A2 --> A3 --> A4
        A4 -.->|jatkaa, jos laajuus<br/>edellyttää useampia<br/>välitapaamisia| A3
        A4 --> A5 --> A6
    end

    subgraph VALMENTAJA["Valmentaja"]
        direction TB
        V1["Tilannekartoitus,<br/>GAS, kolmen kysymyksen<br/>mittari, SUUNTA + LAAJUUS<br/>(vaihe 1)"]
        V2["Suosittelee 2-4<br/>sisältöä + arvioi tason<br/>(vaihe 2)"]
        V3["Näkee etenemis-<br/>yhteenvedon ennen<br/>tapaamista<br/>(vaihe 3)"]
        V4["ReTeaming/MI, GAS-päivitys,<br/>mittari uudelleen,<br/>voi muuttaa SUUNTAA<br/>(vaihe 4)"]
        V5["Aktivoi jälkiseuranta-<br/>moduulin<br/>(vaihe 5)"]
        V6["Arvioi GAS-tavoitteet,<br/>päättää tai jatkaa<br/>(vaihe 6)"]
        V1 --> V2 --> V3 --> V4
        V4 -.->|suunta voi muuttua| V1
        V4 --> V5 --> V6
    end

    subgraph ALUSTA["Digialusta"]
        direction TB
        D2["Näyttää VAIN valitun<br/>suunnan sisällön,<br/>tasoittain jaoteltuna<br/>(vaihe 2)"]
        D3["Tallentaa etenemisen,<br/>ei pakota järjestystä,<br/>ei ohjaa automaattisesti<br/>(vaihe 3)"]
        D5["Avaa siirtymämoduulin:<br/>tavoiteseuranta, check-init,<br/>työnantajakeskustelut<br/>(vaihe 5)"]
        D6["Arkistoi tiedot,<br/>mahdollistaa paluun<br/>myöhemmin<br/>(vaihe 6)"]
        D2 --> D3 --> D5 --> D6
    end
    ...
    classDef kasvokkain fill:#F0997B,stroke:#712B13,color:#4A1B0C
    classDef alusta fill:#5DCAA5,stroke:#085041,color:#04342C
    classDef siirtyma fill:#AFA9EC,stroke:#3C3489,color:#26215C
    classDef paattyy fill:#B4B2A9,stroke:#444441,color:#2C2C2A

    class A1,A4,V1,V4 kasvokkain
    class A2,A3,V2,V3,D2,D3 alusta
    class A5,V5,D5 siirtyma
    class A6,V6,D6 paattyy
```
...
![Digivalmennuksen työnkulut: tapaamistyypit ja prosessivaiheet (JHS 152, taso 4)](kuvat/tyonkulut_tapaamistyypit.png)
